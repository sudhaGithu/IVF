...
//timeSlot Routes
router.post('/createTimeSlot', authentication.adminauthenticate,checkPermission('Schedule','Create'), timeSlotController.createTimeSlot);
router.get('/getTimeSlots', authentication.adminauthenticate,checkPermission('Schedule','Read'), timeSlotController.getTimeSlots);  
router.get('/getTimeSlotById/:id',authentication.adminauthenticate,checkPermission('Schedule','Read'), timeSlotController.getTimeSlotById);
router.put('/updateTimeSlot/:id',authentication.adminauthenticate,checkPermission('Schedule','Update'), timeSlotController.updateTimeSlot);
router.delete('/deleteTimeSlot/:id',authentication.adminauthenticate,checkPermission('Schedule','delete'),timeSlotController.deleteTimeSlot);

//schedule Routes
router.post('/createSchedule', authentication.adminauthenticate,checkPermission('Schedule','Create'), scheduleController.createSchedule);
router.get('/getSchedules',authentication.adminauthenticate,checkPermission('Schedule','Read'), scheduleController.getSchedules);
router.get('/getScheduleById/:id', authentication.adminauthenticate,checkPermission('Schedule','Read'), scheduleController.getScheduleById);
router.put('/updateSchedule/:id',authentication.adminauthenticate,checkPermission('Schedule','Update'),scheduleController.updateSchedule);
router.delete('/deleteSchedule/:id',authentication.adminauthenticate,checkPermission('Schedule','delete'), scheduleController.deleteSchedule);
