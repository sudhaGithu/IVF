...
router.post('/createMedicineCategory', authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'),upload.fields([{ name: 'categoryImage' }, { name: 'bannerImage' }]), MedicineCategoryController.createMedicineCategory);
router.get('/getAllMedicineCategories',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), MedicineCategoryController.getAllMedicineCategories);
router.get('/getMedicineCategoryById/:id', authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'),MedicineCategoryController.getMedicineCategoryById);
router.put('/updateMedicineCategory/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'), upload.fields([{ name: 'categoryImage' }, { name: 'bannerImage' }]), MedicineCategoryController.updateMedicineCategory);
router.delete('/deleteMedicineCategory/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), MedicineCategoryController.deleteMedicineCategory);


// Routes for Leaf CRUD operations
router.post('/leaf/Add',authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'), LeafController.createLeaf);
router.get('/leafs/All',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), LeafController.getAllLeaves);
router.get('/getLeafById/:id', authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'),LeafController.getLeafById);
router.put('/updateLeaf/:id', authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'),LeafController.updateLeaf);
router.delete('/deleteLeaf/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), LeafController.deleteLeaf);

//medicine Routes
router.post('/medicine/Add',authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'), medicineController.createMedicine);
router.get('/medicine/All',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), medicineController.getAllMedicines);
router.put('/updateMedicine',authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'), medicineController.updateMedicine);
router.delete('/deleteMedicine',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), medicineController.deleteMedicine);
router.get('/getMedicineById/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), medicineController.getMedicineById);


// Routes for pharnaType CRUD operations
router.post('/createType',authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'), TypeController.createType);
router.get('/getAllTypes',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), TypeController.getAllTypes);
router.get('/getTypeById/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), TypeController.getTypeById);
router.put('/updateType/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'), TypeController.updateType);
router.delete('/deleteType/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), TypeController.deleteType);

// Routes for Type CRUD operations
router.post('/createUnit',authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'), unitController.createUnit);
router.get('/getAllUnits',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), unitController.getAllUnits);
router.get('/getUnitById/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), unitController.getUnitById);
router.put('/updateUnit/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'), unitController.updateUnit);
router.delete('/deleteUnit/:id',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), unitController.deleteUnit);

//VendorRoutes
router.post('/createVendor',authentication.adminauthenticate,checkPermission('Pharmacy Management','Create'), vendorController.createVendor);
router.get('/getVendors',authentication.adminauthenticate,checkPermission('Pharmacy Management','Read'), vendorController.getVendors);
router.put('/updateVendor', authentication.adminauthenticate,checkPermission('Pharmacy Management','Update'),vendorController.updateVendor);
router.delete('deleteVendor',authentication.adminauthenticate,checkPermission('Pharmacy Management','Delete'), vendorController.deleteVendor);
